...
void myefx::defineControllers(tChannel *defaultChannel)
{
	...
	addProperty(defaultIntensity[0],"Red-intensity","intensità del flash (additivo) Rosso");
	addProperty(defaultIntensity[1],"Green-intensity","intensità del flash (additivo) Verde");
	addProperty(defaultIntensity[2],"Blue-intensity","intensità del flash (additivo) Blu");
}
