...
int AD_ParticleSystem::init(void)
{
  ...
  matflare.trasparency=MIXTYPE_ADD;
...
;
  ...
  for (i=0; i<max_particles; i++)
  {
	if (particles[i].age > 0)
	{
	  ...
	  {
		zp=(cam_pos.z-znear)*inv_zfar_znear;
